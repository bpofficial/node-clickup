...
export declare type UpdateGoal = Partial<CreateGoal>;
export interface UpdateGoalOpts {
    goalId: string;
    data: UpdateGoal;
}
export declare type UpdateGoalResponse = CreateGoalResponse;
...
export declare type UpdateKeyResult = any;
...
export declare type GetGoalResponse = CreateGoalResponse;
